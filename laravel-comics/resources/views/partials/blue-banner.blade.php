<div style="background: #2196f3; padding: 30px 0;">
    <div style="max-width: 1200px; margin: 0 auto; display: flex; justify-content: center; align-items: center; gap: 60px;">
        ...
        <div style="display: flex; flex-direction: column; align-items: center; color: #fff;">
            <img src="" alt="DC Merchandise" style="height: 50px; margin-bottom: 8px;">
            <span>DC MERCHANDISE</span>
        </div>
        <div style="display: flex; flex-direction: column; align-items: center; color: #fff;">
            <img src="" alt="Subscription" style="height: 50px; margin-bottom: 8px;">
            <span>SUBSCRIPTION</span>
        </div>
        <div style="display: flex; flex-direction: column; align-items: center; color: #fff;">
            <img src="" alt="Comic Shop Locator" style="height: 50px; margin-bottom: 8px;">
            <span>COMIC SHOP LOCATOR</span>
        </div>
        <div style="display: flex; flex-direction: column; align-items: center; color: #fff;">
            <img src="" alt="DC Power Visa" style="height: 50px; margin-bottom: 8px;">
